...
// in this program it does not at all, we just need one attribute to mimic its usage in BranchMesh
struct Meristem
{
	double skinThickness;

	Meristem(double SKINTHICKNESS) : skinThickness(SKINTHICKNESS) {}
};
